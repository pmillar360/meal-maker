...
import { getShoppingList, addShoppingListItem, updateShoppingListItem, deleteShoppingListItem } from '../services/api';
                    ...
                    .map(item => (
                      ...
                      >
                        ...
                        <div className="flex-grow">
                          ...
                          {item.quantity && (
                            <p className="text-sm line-through">{item.quantity}</p>
                          )}
                        </div>
                        <button 
                          onClick={() => handleDeleteItem(item.id)}
